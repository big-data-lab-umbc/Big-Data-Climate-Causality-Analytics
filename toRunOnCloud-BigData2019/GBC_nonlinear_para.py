...
with open("output_nonlinear_para.csv", "w", newline='') as f:
    for row in result:
        f.write("%s\n" % ','.join(str(col) for col in row))

with open('output_nonlinear_para.csv') as input, open('output_nonlinear_para_{}.csv'.format(data_file_name), 'w', newline='') as output:
