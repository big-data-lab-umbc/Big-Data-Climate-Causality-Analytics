...
def boosting(x_list_name, y_name, maxlag, data_ori=data_input):
    ...
    return mse_arr, predicted_name_list, r2_arr, maxlag, k, x_list_name
...
def causality_test(boosting_result_list):
    ...
    k = boosting_result_list[4]
    x_list_name = boosting_result_list[5]
...
with open('out_linear_para.csv') as finalInput, open('output_linear_para_{}'.format(data_file_name), 'w', newline='') as output:
